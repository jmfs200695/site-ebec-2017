<!-- Annual partners -->
<section class="" style="padding: 20px 40px">
	<div class="row seven-cols vertical-align">
		<div class="col-md-1 col-sm-4 col-xs-4">
			<a href="https://www.ua.pt/">
				<img class="img-responsive img-grayscale img-footer img-center" alt="" src="<?php echo base_url('assets/img/partners/annual/ua.png') ?>">					
			</a>
		</div>
		<div class="col-md-1 col-sm-4 col-xs-4">
