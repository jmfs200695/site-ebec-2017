		            ...
		            <blockquote>
		              <div class="row">
		                ...
		                <div class="col-sm-8">
		                  ...
		                  Em 2014 surgiu a oportunidade de abraçar o desafio de ser MO da EBEC Aveiro'15. 
		                  ...
		                  ver todo o trabalho de uma fantástica equipa fez com que tudo vale-se a pena. Ser MO de um 
		          ...
		          <div class="item active">
		            <blockquote>
		              <div class="row">
		                ...
		                <div class="col-sm-8">
		                  <p class="text-justify">
		                  	A minha experiência enquanto Main Organiser da EBEC Aveiro 2014 permitiu-me melhorar várias 
		          ...
		          <div class="item active">
		            <blockquote>
		              <div class="row">
		                ...
		                <div class="col-sm-8">
		                  <p class="text-justify">Ser MO da EBEC foi não ter um dia normal durante uns meses. Foi maior 
...
<section class="bg-gray">
	<div class="container">
	    ...
	    <div class="row">	    	     
	        <div class="col-md-12">                
	            <p class="text-muted text-justify">
	            	A IV Edição da EBEC Aveiro decorreu nos dias 3, 4 e 7 março de 2014, tendo esta edição a 
		        ...
		        <div class="carousel-inner">
		          ...
		          <div class="item active">
		            <blockquote>
		              <div class="row">
		                <div class="col-sm-3 text-center">
		                  <img class="img-circle" src="<?php echo base_url('assets/img/past-editions/testimonials/mo_2012.png')?>">
		                </div>
		                <div class="col-sm-8">
		                  <p class="text-justify">
						  </p>
		                  <small>
		                  	Miguel Garcia<br/>
		                  	Coordenador da EBEC Aveiro 2012
		                  </small>
		                </div>
		              </div>
		            </blockquote>
