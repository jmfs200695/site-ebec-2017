...
<!--                            TODO fazer mais tarde link na palavra-->
                            ...
                            Podes fazê-lo <a data-toggle="tooltip" title="<img width='600px'  src='<?php echo base_url('assets/img/inscricao1.PNG')?>'/>" target="_blank" href="http://www.best.eu.org/student/register/disclaimer.jsp">aqui</a>.
                        </p>
                    </li>
                    <li class="text-muted">
                        <p class="text-muted text-justify">
