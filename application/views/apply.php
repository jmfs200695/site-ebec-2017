              	...
              	<ul class="fa-ul">
              		<li class="text-muted">
						<p class="text-muted text-justify">
							...
							Podes fazê-lo <a target="_blank" href="http://www.best.eu.org/student/register/disclaimer.jsp">aqui</a>.
						</p>
					</li>
					<li class="text-muted">
						<p class="text-muted text-justify">
							<span class="big-number">2.</span> Efetua a pré-inscrição na EBEC Aveiro 2016.
					...
					<li class="text-muted">
						<p class="text-muted text-justify">
							...
							Aveiro 2016. Brevemente irás receber um e-mail de confirmação de inscrição com mais informação sobre o evento.
						</p>
					</li>
					<br/>
				</ul> 
